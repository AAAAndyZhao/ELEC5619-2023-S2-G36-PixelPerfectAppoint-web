    ...
    <div class="app-photo-info-form">
        <el-form :model="photoForm" label-width="120px" :rules="rules" ref="photoFormRef">
            ...
            <el-form-item label="Description:" prop="description">
                <el-input :disabled="!props.photo" type="textarea" v-model="photoForm.description" :rows="4" resize="none"
                    size="large"></el-input>
            </el-form-item>
        </el-form>
    </div>
...
watchEffect(() => {
    ...
    if (props.postData) {
        ...
        description: props.postData.text,
    
        };
        console.log("表单现在的值",photoForm.value);
        return;
    }
